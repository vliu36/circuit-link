...
export async function login(email: string, password: string) {
    ...
    // return user;
    window.location.href = `${process.env.CLIENT_URI}/landing`
    } catch (err: any) {
...
export async function loginWithGoogle() {
    try {
        ...
        if (docSnap.exists()) {
            ...
            window.location.href = `${process.env.CLIENT_URI}/landing`;   // TODO: Redirect to landing page
        ...
        const res = await fetch(`${process.env.CLIENT_URI}/api/users/register-google`, {
            method: "POST",
        ...
        // window.location.href = "http://${process.env.CLIENT_URI}/dashboard"
        window.location.href = `${process.env.CLIENT_URI}/landing` // TODO: Redirect to landing page
